...
/**
 * x4 types for API compatibility with the AVX2 optimized version.
 * On ARM, we implement x4 as 4 sequential single instances.
 */
typedef struct {
    Keccak_HashInstance instances[4];
} Keccak_HashInstancetimes4;

typedef Keccak_HashInstancetimes4 shake_prng_x4_t;
typedef Keccak_HashInstancetimes4 shake_sha3_x4_t;

/* x4 sequential wrappers — same API as AVX2 KeccakHashtimes4 */
...
/* Single-instance API (unchanged from reference) */
